...
namespace GameSystems.InfrastructureLayer.DialogueDirectingSystem
{
    public class ActorGenerator
    {
        ...
        private IRuntimeActorDB runtimeActorDB;

        private string ActorSOPath = "ScriptableObjects/DialogueDirectingSystem/ActorPrefabSO";

        public ActorGenerator(IRuntimeActorDB runtimeActorDB)
        {
