...
namespace GameSystems.DialogueDirectingService.Datas
{
    public interface IDialogueDirectingPrefabDataSO
    {
        ...
        public IEnumerable<DialogueDirectingPrefabData> DialogueDirectingPrefabDataList { get; }
    }

    // 연출에 사용될 수 있는 모든 Prefab들을 모아놓은 SO파일.
    [SerializeField]
    [CreateAssetMenu(menuName = "ScriptableObjects/DialogueDirectingService/PrefabDataSO", fileName = "PrefabDataSO")]
    public class DialogueDirectingPrefabDataSO : ScriptableObject, IDialogueDirectingPrefabDataSO
    {
        ...
        public IEnumerable<DialogueDirectingPrefabData> DialogueDirectingPrefabDataList => this.DialogueDirectingPrefabDatas;
    }
}