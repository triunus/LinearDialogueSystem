...
namespace GameSystems.DialogueDirectingService.Generator
{
    ...
    public class DialogueDirectingControlDataGenerator
    {
        ...
        private string dialogueDirectingJsonDataSOPath = "ScriptableObjects/DialogueDirectingService/DialogueDirectingJsonDataSO";

        public DialogueDirectingControlDataGenerator(IDialogueDirectingControlData dialogueDirectingControlData)
        {
