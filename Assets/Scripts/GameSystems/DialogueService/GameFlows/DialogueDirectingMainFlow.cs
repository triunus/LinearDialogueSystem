...
namespace GameSystems.DialogueDirectingService.GameFlow
{
    ...
    {
        // Image 연출 하위 flow
        private IDialogueImageDirectingSubFlow DialogueImageDirectingSubFlow;
...
/*        private void InitialSetting()
            ...
            switch (currentDirectingType)
            {
                case DirectingType.DialogueTextDirectingType:
                    ...
                    if (this.DialogueTextDirectingView.TryDirectTextDisplayOperation(dialogueDirectingData.DirectingContent, out var textDisplayCo, out var textDisplayToken) && textDisplayCo != null
                        && this.DialogueImageDirectingSubFlow.TrySetSpeakerAndListenerColor(dialogueDirectingData.DirectingContent))
                    {
                        this.DialogueDirectingControlData.TextDirectingCoroutineControlData.DirectingIndex = dialogueDirectingData.Index;
                        this.DialogueDirectingControlData.TextDirectingCoroutineControlData.BehaviourCoroutine = this.CoroutineRunner.Run(textDisplayCo);
                        this.DialogueDirectingControlData.TextDirectingCoroutineControlData.ControlCoroutine = this.CoroutineRunner.Run(this.OperateTextDisplayCoroutine());
                        this.DialogueDirectingControlData.TextDirectingCoroutineControlData.BehaviourToken = textDisplayToken;
                ...
                case DirectingType.DialogueImageDirectingType:
                    Debug.Log($"호출됨 6");
                    if (this.DialogueImageDirectingSubFlow.TryAction(dialogueDirectingData.DirectingContent, out var ImageDirectingCo, out var imageBehaviourToken) && ImageDirectingCo != null)
                    {
                        DialogueDirectingCoroutineControlData newDirectingCoroutineControlData = new DialogueDirectingCoroutineControlData();
                        this.ActionDirectingCoroutineControlDatas.Add(newDirectingCoroutineControlData);
        ...
        {
            yield return this.DialogueDirectingControlData.TextDirectingCoroutineControlData.BehaviourCoroutine;

            this.DialogueDirectingControlData.TextDirectingCoroutineControlData.BehaviourCoroutine = null;
            this.DialogueDirectingControlData.TextDirectingCoroutineControlData.ControlCoroutine = null;
        ...
        private void RequestNextDirecting()
        {
            ...
            if (this.LastDirectingData.IsAutoable && this.DialogueDirectingControlData.TextDirectingCoroutineControlData.IsOperationEnd() && this.ActionDirectingCoroutineControlDatas.Count == 0)
            {
        ...
        public void OperateDialogueClickInteraction()
        {
            ...
            if (this.ActionDirectingCoroutineControlDatas.Count == 0 && this.DialogueDirectingControlData.TextDirectingCoroutineControlData.IsOperationEnd())
            {
        ...
        {
            if (!this.DialogueDirectingControlData.TextDirectingCoroutineControlData.IsOperationEnd())
            {
                this.DialogueDirectingControlData.TextDirectingCoroutineControlData.BehaviourToken.IsRequestEnd = true;
            }
