...
namespace GameSystems.InfrastructureLayer.DialogueDirectingSystem
{
    public class BackGroundGenerator
    {
        ...
        private IRuntimeBackGroundDB runtimeBackGroundDB;

        private string BackGroundSOPath = "ScriptableObjects/DialogueDirectingSystem/BackGroundPrefabSO";

        public BackGroundGenerator(IRuntimeBackGroundDB runtimeBackGroundDB)
        {
